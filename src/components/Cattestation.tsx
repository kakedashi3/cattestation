...
export const CattestationABI = [
  {
    inputs: [
      { internalType: "address", name: "eas_", type: "address" },
      { internalType: "bytes32", name: "easPetSchema_", type: "bytes32" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "cat", type: "address" }],
    name: "UnknownCatTBH",
    type: "error",
  },
  {
  ...
  },
  {
    ...
    name: "list",
    outputs: [
      { internalType: "address[]", name: "catslice", type: "address[]" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "message", type: "string" },
      {
        ...
        internalType: "struct Cattestation.ECDSASignature",
        name: "sig",
        type: "tuple",
      },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "cat", type: "address" },
      {
        ...
        internalType: "struct Cattestation.Catadata",
        name: "catadata",
        type: "tuple",
      },
    ],
...
export function Cattestation() {
  ...
  const { config, error } = usePrepareContractWrite({
    ...
    args: [
      ...
      message,
      {
        v: data?.signature.raw.v,
        r: (`0x` + data?.signature.raw.r) as Address,
        s: (`0x` + data?.signature.raw.s) as Address,
      },
    ],
  });
  ...
  async function onClick() {
    ...
    const data = await execHaloCmdWeb(command);
  ...
  if (write) {
    return (
      <>
        <div>{error?.message ?? txError?.message}</div>
        <Button
          className="w-full"
          onClick={() => write()}
  ...
  return (
    <>
      ...
      />
      <Button className="w-full" onClick={onClick} disabled={!isConnected}>
        Verify Cattestation {!isConnected && "(connect wallet)"}
      </Button>
    </>
  );
}
